...
# Miscellaneous
    ...
    def is_valid_triangulation_file(cls, triangulation_file):
        ...
        **License:** `Geosoft End-User License <https://geosoftgxdev.atlassian.net/wiki/spaces/GD/pages/2359406/License#License-end-user-lic>`_
        """
        ret_val = gxapi_cy.WrapVULCAN._is_valid_triangulation_file(GXContext._get_tls_geo(), triangulation_file.encode('utf8'))
        return ret_val
    ...
    def is_valid_block_model_file(cls, block_model_file):
        ...
        **License:** `Geosoft End-User License <https://geosoftgxdev.atlassian.net/wiki/spaces/GD/pages/2359406/License#License-end-user-lic>`_
        """
        ret_val = gxapi_cy.WrapVULCAN._is_valid_block_model_file(GXContext._get_tls_geo(), block_model_file.encode('utf8'))
        return ret_val
    ...
    def triangulation_to_view(cls, triangulation_file, ipj, mview, new_group_name):
        ...
        **License:** `Geosoft End-User License <https://geosoftgxdev.atlassian.net/wiki/spaces/GD/pages/2359406/License#License-end-user-lic>`_
        """
        gxapi_cy.WrapVULCAN._triangulation_to_view(GXContext._get_tls_geo(), triangulation_file.encode('utf8'), ipj, mview, new_group_name.encode('utf8'))
    ...
    def get_block_model_variable_info(cls, block_model_file, query, lst):
        ...
        **License:** `Geosoft End-User License <https://geosoftgxdev.atlassian.net/wiki/spaces/GD/pages/2359406/License#License-end-user-lic>`_
        """
        gxapi_cy.WrapVULCAN._get_block_model_variable_info(GXContext._get_tls_geo(), block_model_file.encode('utf8'), query, lst)
    ...
    def get_block_model_string_variable_values(cls, block_model_file, variable_name, lst):
        ...
        **License:** `Geosoft End-User License <https://geosoftgxdev.atlassian.net/wiki/spaces/GD/pages/2359406/License#License-end-user-lic>`_
        """
        gxapi_cy.WrapVULCAN._get_block_model_string_variable_values(GXContext._get_tls_geo(), block_model_file.encode('utf8'), variable_name.encode('utf8'), lst)
    ...
    def block_model_to_voxel(cls, block_model_file, ipj, variable_to_export, output_voxel_filename, remove_default_values, rock_code_filename):
        ...
        **License:** `Geosoft End-User License <https://geosoftgxdev.atlassian.net/wiki/spaces/GD/pages/2359406/License#License-end-user-lic>`_
        """
        gxapi_cy.WrapVULCAN._block_model_to_voxel(GXContext._get_tls_geo(), block_model_file.encode('utf8'), ipj, variable_to_export.encode('utf8'), output_voxel_filename.encode('utf8'), remove_default_values, rock_code_filename.encode('utf8'))
